        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('nilaiketerampilan.store') }}" method="POST">
                @csrf
                  ...
                  <table class="table table-bordered table-hover">
                    <thead class="bg-primary">
                      ...
                      <tr>
                        ...
                        <input type="hidden" name="k13_rencana_nilai_keterampilan_id[]" value="{{$rencana_penilaian->id}}">
                        <td style="width: 300px;"><small><b>{{$rencana_penilaian->k13_kd_mapel->kode_kd}}</b> {{$rencana_penilaian->k13_kd_mapel->ringkasan_kompetensi}}</small></td>
                        @endforeach
                      </tr>
                    </thead>
                    <tbody>
