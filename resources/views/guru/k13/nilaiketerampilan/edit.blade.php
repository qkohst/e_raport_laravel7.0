        ...
        <div class="col-12">
          <div class="card">
                  ...
                  <table class="table table-bordered table-hover">
                    <thead class="bg-primary">
                      ...
                      <tr>
                        ...
                        <input type="hidden" name="k13_rencana_nilai_keterampilan_id[]" value="{{$kd_nilai->k13_rencana_nilai_keterampilan_id}}">
                        <td style="width: 300px;"><small><b>{{$kd_nilai->k13_rencana_nilai_keterampilan->k13_kd_mapel->kode_kd}}</b> {{$kd_nilai->k13_rencana_nilai_keterampilan->k13_kd_mapel->ringkasan_kompetensi}}</small></td>
                        @endforeach
                      </tr>
                    </thead>
                    <tbody>
            ...
            <div class="card-footer clearfix">
              ...
              <a href="{{ route('nilaiketerampilan.index') }}" class="btn btn-default float-right mr-2">Batal</a>
            </div>
            </form>
          </div>
          <!-- /.card -->
