        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('nilaiptspas.store') }}" method="POST">
                @csrf
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="number" class="form-control" name="nilai_pts[]" min="0" max="100" required oninvalid="this.setCustomValidity('Nilai harus berisi antara 0 s/d 100')" oninput="setCustomValidity('')">
                        </td>
                        <td>
                          <input type="number" class="form-control" name="nilai_pas[]" min="0" max="100" required oninvalid="this.setCustomValidity('Nilai harus berisi antara 0 s/d 100')" oninput="setCustomValidity('')">
                        </td>
