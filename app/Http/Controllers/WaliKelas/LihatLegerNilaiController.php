...
class LihatLegerNilaiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('walikelas.leger.index', compact('title', 'data_mapel_kelompok_a', 'data_mapel_kelompok_b', 'data_ekstrakulikuler', 'count_ekstrakulikuler', 'data_anggota_kelas'));
    }
